               ...
               <tr>
                   ...
                   <td style="height: auto;background: lightgray;border: inset 1px antiquewhite;"><div style=" width: 100%;border-radius: 3px;">
                           ...
                           <div style="float: right;width: 75%; height: auto;">
                               <br><br><br><br><br><fieldset style=" margin-left: 50px; background: gainsboro; width: 50%; height: auto;font-size: 15px;color: #000; font-family: verdana, helvetica, arial, sans-serif;line-height: 23px;">
                                   <legend><B>Update for Address</B></legend>
                                   <form action="UpdateController" method="post">
                <table  cellpadding="10">
                    
            <tr>
                <td>Enter Address </td>
                <td><textarea name="add" required="" placeholder=" Enter your Full Address"cols="25" rows="3" style="color: black;font-weight: bold;"></textarea>
                     <input type="hidden" name="hd" value="<%=m %>">
                </td>
                
                
            </tr>
            <tr>
                <td colspan="2" align="right"><input type="submit" name="btn" value="Save Address" style="background: #5bc0de"></td>   
            </tr>
        </table>
...
if(mes!=null){
    %>
 <div style="background: white;padding: 8px;width:51%;margin-left: 50px; ">   <font style="color:green;"> <%=mes%></font> &nbsp;<a id="i"href="Profile_Info.jsp">Back to Profile Home</a>  </div>
    <%
}
%>
