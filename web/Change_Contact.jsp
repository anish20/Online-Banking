...
<div style="float: right;padding-top: 20px;padding-bottom: 60px;padding-left: 20px;padding-right: 50px;font-size: 13px;color: #000; font-family: verdana, helvetica, arial, sans-serif;line-height: 23px;">Last Accessed Time:<%=new Date(session.getLastAccessedTime()) %></div>      
               ...
               <tr>
                   ...
                   <td style="height: auto;background: lightgray;border: inset 1px antiquewhite;"><div style=" width: 100%;border-radius: 3px;">
                           ...
                           <br><br><br><br><br><fieldset style="margin: 10px;background: gainsboro; margin-left: 50px;  width: 50%; height: auto;font-size: 13px;color: #000; font-family: verdana, helvetica, arial, sans-serif;line-height: 23px;">
                               <legend><b>Update for Contact No</b></legend>
                               <form action="UpdateController" method="post">
                                   <br> <table cellpadding="5">
                    
            <tr>
                <td> Contact No: <input type="text" maxlength="10" name="cont" placeholder=" Enter New Contact No" required="Please Enter Contact No">
                <input type="hidden" name="hd" value="<%=m %>">
                </td>
                <td><input type="submit" name="btn" value="Update Contact" style="background: #5bc0de"></td>
...
if(mes!=null){
    %>
 <div style="background: white;padding: 5px;">   <font style="color:green;"> <%=mes%></font> &nbsp;<a id="i"href="Profile_Info.jsp">Back to Profile Home</a>  </div>
    <%
}
%>
